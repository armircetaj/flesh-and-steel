...
public partial class GhostProjectile : Area2D
{
	...
	/// <summary>
	/// Imposta la direzione iniziale e il danno del proiettile prima che inizi il suo movimento.
	/// </summary>
	...
	/// <summary>
	/// Gestisce le collisioni del proiettile: infligge danno se colpisce il giocatore
	/// (rispettando il tipo di danno Ranged), altrimenti si distrugge contro i muri.
	/// Ignora le collisioni con altri nemici per evitare fuoco amico.
	/// </summary>
